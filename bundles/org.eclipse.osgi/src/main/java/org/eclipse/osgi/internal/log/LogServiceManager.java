...
@Capability(namespace = SERVICE_NAMESPACE, attribute = "objectClass:List<String>='org.osgi.service.log.admin.LoggerAdmin'", uses = LoggerAdmin.class)
@Capability(namespace = SERVICE_NAMESPACE, attribute = "objectClass:List<String>='org.osgi.service.log.LogService,org.osgi.service.log.LoggerFactory,org.eclipse.equinox.log.ExtendedLogService'", uses = {
		LogService.class, LoggerFactory.class, ExtendedLogService.class })
@Capability(namespace = SERVICE_NAMESPACE, attribute = "objectClass:List<String>='org.osgi.service.log.LogReaderService,org.eclipse.equinox.log.ExtendedLogReaderService'", uses = {
		LogReaderService.class, ExtendedLogReaderService.class })
