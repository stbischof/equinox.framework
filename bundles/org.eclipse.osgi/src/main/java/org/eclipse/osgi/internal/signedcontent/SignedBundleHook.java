...
@Capability(namespace = SERVICE_NAMESPACE, attribute = {
		"objectClass:List<String>='org.eclipse.osgi.service.security.TrustEngine'",
		SignedContentConstants.TRUST_ENGINE + "type='" + SignedContentConstants.DEFAULT_TRUST_ENGINE
				+ "'" }, uses = TrustEngine.class)
@Capability(namespace = SERVICE_NAMESPACE, attribute = "objectClass:List<String>='org.eclipse.osgi.signedcontent.SignedContentFactory'", uses = SignedContentFactory.class)
