...
public class DebugOptionsTestCase extends CoreTest {
	...
	public void testVerboseDebugging() {
		...
		try {
			...
			Assertions.fail(
					"Failed 'DebugTrace.trace(option, message)' test as an invalid trace entry was found.  Actual Value: '" //$NON-NLS-1$
							+ invalidEx.getActualValue() + "'.", //$NON-NLS-1$
					invalidEx);
		}
	...
	*/
	...
	public void testTraceFile02() {
		...
		try {
			...
			Assertions.fail(
					"Failed 'DebugTrace.trace(option, message, Throwable)' test as an invalid trace entry was found.  Actual Value: '" //$NON-NLS-1$
							+ invalidEx.getActualValue() + "'.", //$NON-NLS-1$
					invalidEx);
		}
	...
	*/
	public void testTraceFile03() {
		...
		try {
			...
			Assertions.fail(
					"Failed 'DebugTrace.traceDumpStack(option)' test as an invalid trace entry was found.  Actual Value: '" //$NON-NLS-1$
							+ invalidEx.getActualValue() + "'.", //$NON-NLS-1$
					invalidEx);
		}
		assertEquals("Wrong number of trace entries", 2, traceOutput.length); //$NON-NLS-1$
	...
	*/
	public void testTraceFile04() {
		...
		try {
			...
			Assertions.fail(
					"Failed 'DebugTrace.traceEntry(option)' test as an invalid trace entry was found.  Actual Value: '" //$NON-NLS-1$
							+ invalidEx.getActualValue() + "'.", //$NON-NLS-1$
					invalidEx);
		}
		assertEquals("Wrong number of trace entries", 2, traceOutput.length); //$NON-NLS-1$
	...
	public void testTraceFile05() {
		...
		try {
			...
			Assertions.fail(
					"Failed 'DebugTrace.traceEntry(option, methodArgument)' test as an invalid trace entry was found.  Actual Value: '" //$NON-NLS-1$
							+ invalidEx.getActualValue() + "'.", //$NON-NLS-1$
					invalidEx);
		}
		assertEquals("Wrong number of trace entries", 2, traceOutput.length); //$NON-NLS-1$
	...
	*/
	public void testTraceFile07() {
		...
		try {
			...
			Assertions.fail(
					"Failed 'DebugTrace.traceExit(option)' test as an invalid trace entry was found.  Actual Value: '" //$NON-NLS-1$
							+ invalidEx.getActualValue() + "'.", //$NON-NLS-1$
					invalidEx);
		}
		assertEquals("Wrong number of trace entries", 2, traceOutput.length); //$NON-NLS-1$
	...
	*/
	public void testTraceFile08() {
		...
		try {
			...
			Assertions.fail(
					"Failed 'DebugTrace.traceExit(option, result)' test as an invalid trace entry was found.  Actual Value: '" //$NON-NLS-1$
							+ invalidEx.getActualValue() + "'.", //$NON-NLS-1$
					invalidEx);
		}
		assertEquals("Wrong number of trace entries", 2, traceOutput.length); //$NON-NLS-1$
	...
	*/
	...
	private TraceEntry[] readTraceFile(File traceFile) throws InvalidTraceEntry {
		...
		try {
			...
			Assertions.fail("Failed to read trace file", ex); //$NON-NLS-1$
		} finally {
			if (traceReader != null) {
				try {
					traceReader.close();
