...
public class PlatformAdminTest extends AbstractStateTest {
	...
	public void testBug205270() throws BundleException {
		...
		try {
			...
			Assertions.fail("Unexpected error while cloning a BundleDescription", t);
		}
	}
	...
	public void testBug184127() throws BundleException {
		...
		try {
			...
			Assertions.fail("failed to shudown StateManager", e);
		}
		...
		try {
			...
			Assertions.fail("Unexpected exception getting exports", e);
		}
