...
//	BundleInstaller installer;
	...
	@Test
	public void testInstallWithLocation01() throws IOException, BundleException {
	...
	@Test
	public void testInstallWithLocation02() throws IllegalArgumentException, IOException, BundleException {

		URL url = embeddeLocation(bc, "tb_test1.jar").getURL(bc); //$NON-NLS-1$

		Bundle testBundle = bc.installBundle(url.toString(), null);
		BundleAssert.assertThat(testBundle).isNotNull().hasSymbolicName("test1"); //$NON-NLS-1$
